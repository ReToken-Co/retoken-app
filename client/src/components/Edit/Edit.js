...
import { Paper, FormControl, TextField, Grid } from "@material-ui/core";
...
export default function Edit(props) {
  ...
  const RenderButton = () => {
    console.log(`btn ${props.id} ${props.status} ${props.account}`);
    ...
    <div>
      <div className={classes.root}>
        <Paper className={classes.paper}>
          ...
          <TextField className={classes.textField}id="owner1" label="Owner" disabled variant="outlined" />
          <Controller name="owner" control={control} defaultValue={props.owner}
              as={ <TextField id="owner" label="Owner" fullWidth disabled variant="outlined" /> }
            />
